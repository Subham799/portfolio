...
// Change 1: HTMLDivElement ki jagah HTMLElement kar diya kyunki hum <section> use kar rahe hain
const Contact = forwardRef<HTMLElement, {}>((props, ref) => {
  ...
  return (
    // Change 2: Yahan <section> use ho raha hai, isliye upar HTMLElement lagaya
